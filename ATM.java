...
public class ATM {
    ...
    private int note20Count = 0; //public и записать условие в isvalidamount что кол-во купюр в наличии больше кол-ва требуемых купюр
    ...
    public int getAvailableNote(int amount, int note) {
        ...
        switch (note) {
            case NOTE_20:
                noteCount = amount / NOTE_20;
                break;
            case NOTE_50:
                noteCount = amount / NOTE_50;
                break;
            case NOTE_100:
                noteCount = amount / NOTE_100;
                break;
        }
